    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='invoice.customer')),
                ('product_list', models.ManyToManyField(related_name='product', to='invoice.Inventory')),
            ],
        ),
    ]
